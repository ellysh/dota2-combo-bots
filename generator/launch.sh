...
./generator.py TEAM_DESIRES 15 $CSV_DIR/team_desires.csv > $RESULT_DIR/team_desires.lua

./generator.py PLAYER_DESIRES 17 $CSV_DIR/player_desires.csv > $RESULT_DIR/player_desires.lua
