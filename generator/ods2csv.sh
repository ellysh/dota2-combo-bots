...
cp "$TEMP_DIR/Database.txt.6" "$CSV_DIR/skill_groups.csv"
cp "$TEMP_DIR/Database.txt.7" "$CSV_DIR/attack_target.csv"
cp "$TEMP_DIR/Database.txt.8" "$CSV_DIR/team_desires.csv"
cp "$TEMP_DIR/Database.txt.9" "$CSV_DIR/player_desires.csv"
