...
function test_InitAbilities()
  ...
  luaunit.assertEquals(
    BOT_ABILITIES[1],
    ability_levelup.test_ABILITIES[1])

  luaunit.assertEquals(
    BOT_ABILITIES[2],
    ability_levelup.test_ABILITIES[2])

  luaunit.assertEquals(
    BOT_ABILITIES[3],
    ability_levelup.test_ABILITIES[3])

  luaunit.assertEquals(
    BOT_ABILITIES[6],
    ability_levelup.test_ABILITIES[4])

  luaunit.assertEquals(
    BOT_ABILITIES[7],
    ability_levelup.test_TALENTS[1])

  luaunit.assertEquals(
    BOT_ABILITIES[8],
    ability_levelup.test_TALENTS[2])

  luaunit.assertEquals(
    BOT_ABILITIES[9],
    ability_levelup.test_TALENTS[3])

  luaunit.assertEquals(
    BOT_ABILITIES[10],
    ability_levelup.test_TALENTS[4])

  luaunit.assertEquals(
    BOT_ABILITIES[11],
    ability_levelup.test_TALENTS[5])

  luaunit.assertEquals(
    BOT_ABILITIES[12],
    ability_levelup.test_TALENTS[6])

  luaunit.assertEquals(
    BOT_ABILITIES[13],
    ability_levelup.test_TALENTS[7])

  luaunit.assertEquals(
    BOT_ABILITIES[14],
    ability_levelup.test_TALENTS[8])
end
