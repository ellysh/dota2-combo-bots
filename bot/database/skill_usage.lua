...
M.SKILL_USAGE = {
  ...
  juggernaut_blade_fury = {
      ...
      BOT_MODE_LANING = algorithms["nil"],
      BOT_MODE_ROSHAN = algorithms["use_on_attack_enemy_creep_aoe"],
  ...
  juggernaut_omni_slash = {
      ...
      BOT_MODE_ATTACK = algorithms["max_kills_enemy_hero"],
      BOT_MODE_LANING = algorithms["nil"],
      BOT_MODE_ROSHAN = algorithms["low_hp_ally_hero"],
      BOT_MODE_FARM = algorithms["nil"],
      BOT_MODE_DEFEND_TOWER = algorithms["max_kills_enemy_hero"],
      BOT_MODE_RETREAT = algorithms["nil"],
      BOT_MODE_DEFEND_ALLY = algorithms["max_kills_enemy_hero"]
  ...
  ursa_overpower = {
      any_mode = algorithms["nil"],
      team_fight = algorithms["use_on_attack_enemy_hero_melee"],
      BOT_MODE_ROAM = algorithms["use_on_attack_enemy_hero_melee"],
      BOT_MODE_TEAM_ROAM = algorithms["use_on_attack_enemy_hero_melee"],
      BOT_MODE_PUSH_TOWER = algorithms["nil"],
      BOT_MODE_ATTACK = algorithms["use_on_attack_enemy_hero_melee"],
      BOT_MODE_LANING = algorithms["nil"],
      BOT_MODE_ROSHAN = algorithms["use_on_attack_enemy_creep_melee"],
      BOT_MODE_FARM = algorithms["nil"],
      BOT_MODE_DEFEND_TOWER = algorithms["nil"],
      BOT_MODE_RETREAT = algorithms["nil"],
      BOT_MODE_DEFEND_ALLY = algorithms["nil"]
  ...
  lion_voodoo = {
      ...
      BOT_MODE_ROAM = algorithms["max_estimated_damage_enemy_hero"],
      BOT_MODE_TEAM_ROAM = algorithms["max_estimated_damage_enemy_hero"],
      BOT_MODE_PUSH_TOWER = algorithms["max_estimated_damage_enemy_hero"],
      BOT_MODE_ATTACK = algorithms["max_estimated_damage_enemy_hero"],
      BOT_MODE_LANING = algorithms["nil"],
      BOT_MODE_ROSHAN = algorithms["nil"],
      BOT_MODE_FARM = algorithms["nil"],
  ...
  lion_mana_drain = {
      ...
      BOT_MODE_TEAM_ROAM = algorithms["nil"],
      BOT_MODE_PUSH_TOWER = algorithms["nil"],
      BOT_MODE_ATTACK = algorithms["use_on_attack_enemy_with_mana_when_low_mp"],
      BOT_MODE_LANING = algorithms["use_on_attack_enemy_with_mana_when_low_mp"],
      BOT_MODE_ROSHAN = algorithms["use_on_attack_enemy_with_mana_when_low_mp"],
      BOT_MODE_FARM = algorithms["use_on_attack_enemy_with_mana_when_low_mp"],
      BOT_MODE_DEFEND_TOWER = algorithms["nil"],
      BOT_MODE_RETREAT = algorithms["nil"],
      BOT_MODE_DEFEND_ALLY = algorithms["nil"]
  },
