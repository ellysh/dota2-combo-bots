...
M.test_HasRequiredAuras = HasRequiredAuras
M.test_HasRequiredSkills = HasRequiredSkills
M.test_HasRequiredDamageType = HasRequiredDamageType
M.test_HasRequiredAttackRange = HasRequiredAttackRange
M.test_HasRequiredAttribute = HasRequiredAttribute
M.test_EstimateHero = EstimateHero
