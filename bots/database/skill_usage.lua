...
M.SKILL_USAGE = {
  ...
  phantom_assassin_phantom_strike = {
      any_mode = {algorithms["nil"], nil},
      team_fight = {algorithms["use_on_attack_enemy_hero_ranged"], 0.8},
      BOT_MODE_ROAM = {algorithms["use_on_attack_enemy_hero_ranged"], 0.7},
      BOT_MODE_TEAM_ROAM = {algorithms["use_on_attack_enemy_hero_ranged"], 0.7},
      BOT_MODE_PUSH_TOWER = {algorithms["nil"], nil},
      BOT_MODE_ATTACK = {algorithms["use_on_attack_enemy_hero_ranged"], 0.6},
      BOT_MODE_LANING = {algorithms["nil"], nil},
      BOT_MODE_ROSHAN = {algorithms["use_on_attack_enemy_creep_melee"], 0.9},
      BOT_MODE_FARM = {algorithms["nil"], nil},
      BOT_MODE_DEFEND_TOWER = {algorithms["nil"], nil},
