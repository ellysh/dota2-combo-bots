...
M.SKILL_GROUPS = {
  ...
  creeps_buff = {
      any_mode = {algorithms["nil"], nil},
      team_fight = {algorithms["three_and_more_ally_creeps_self_aoe"], 80},
      BOT_MODE_ROAM = {algorithms["nil"], nil},
      BOT_MODE_TEAM_ROAM = {algorithms["nil"], nil},
      BOT_MODE_PUSH_TOWER = {algorithms["three_and_more_ally_creeps_self_aoe"], 70},
      BOT_MODE_ATTACK = {algorithms["nil"], nil},
      BOT_MODE_LANING = {algorithms["nil"], nil},
      BOT_MODE_ROSHAN = {algorithms["nil"], nil},
      BOT_MODE_FARM = {algorithms["nil"], nil},
      BOT_MODE_DEFEND_TOWER = {algorithms["three_and_more_ally_creeps_self_aoe"], 70},
      BOT_MODE_DEFEND_ALLY = {algorithms["nil"], nil},
      BOT_MODE_RETREAT = {algorithms["nil"], nil},
      BOT_MODE_EVASIVE_MANEUVERS  = {algorithms["nil"], nil}
  },
  ...
  nuke_aoe = {
      ...
      BOT_MODE_LANING = {algorithms["three_and_more_enemy_creeps_aoe"], 50},
      BOT_MODE_ROSHAN = {algorithms["attacked_enemy_creep"], 70},
      BOT_MODE_FARM = {algorithms["three_and_more_neutral_creeps_aoe"], 60},
      BOT_MODE_DEFEND_TOWER = {algorithms["three_and_more_enemy_creeps_aoe"], 90},
